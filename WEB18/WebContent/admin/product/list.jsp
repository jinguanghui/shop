					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="15%">市场价格</td>
							...
							<tr onmouseover="this.style.backgroundColor = 'yellow'"
								...
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%"><img width="40" height="45" src="${pageContext.request.contextPath }/${pro.pimage }"></td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="17%">${pro.pname }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="15%">${pro.shop_price }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="15%">${pro.market_price }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="5%">${pro.is_hot==1?"是":"否" }</td>
